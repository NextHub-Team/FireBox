...
#### In the fast-paced digital age, managing your finances and personal valuables securely has never been more crucial. FireBox is a revolutionary application, leveraging the cutting-edge technology of Fireblocks to provide a seamless and secure digital wallet experience, specifically designed for social media and personal storage.
...
```sh
git clone https://github.com/NextHub-Team/FireBox.git
```
...
- package.json and package-lock.json - Replace FireBox with to-do-list in entire file. Update description.
...
You need to configure your environment variables now. Copy [.env.example](https://github.com/NextHub-Team/FireBox/blob/master/.env.example) and rename as .env. Now provide values for the keys mentioned there. These are going to be database credentials ([created here](#setup-database)) and redis credentials ([created here](#setup-redis)). You don't need to provide all the keys though. For some of these (not needed to be secure keys), we have already specified default values in [.env.defaults](https://github.com/NextHub-Team/FireBox/blob/master/.env.defaults). You can remove them. You will require to fill at least these ones.
...
![db-schema](https://github.com/NextHub-Team/FireBox/blob/master/db-schema.png)
...
This starter project uses [loopback4-authentication](https://github.com/NextHub-Team/loopback4-authentication) package for authentication purposes.

_If you only want to use authentication, not the whole starter codebase, you can use the package directly in you application. Refer [loopback4-authentication](https://github.com/NextHub-Team/loopback4-authentication) documentation for more details._
...
This starter project uses [loopback4-authorization](https://github.com/NextHub-Team/loopback4-authorization) package for authorization purposes.

_If you only want to use authorization, not the whole starter codebase, you can use the package directly in you application. Refer [loopback4-authorization](https://github.com/NextHub-Team/loopback4-authorization) documentation for more details._

Permissions are part of the access token generated. Authorization implementation is following the [Role based permissions with user level override strategy here](https://github.com/NextHub-Team/loopback4-authorization#loopback4-authorization).

#### Soft Delete

This starter project uses [loopback4-soft-delete](https://github.com/NextHub-Team/loopback4-soft-delete) package for authorization purposes.
...
If you've noticed a bug or have a question or have a feature request, [search the issue tracker](https://github.com/NextHub-Team/FireBox/issues) to see if someone else in the community has already created a ticket.
If not, go ahead and [make one](https://github.com/NextHub-Team/FireBox/issues/new/choose)!
All feature requests are welcome. Implementation time may vary. Feel free to contribute the same, if you can.
If you think this extension is useful, please [star](https://help.github.com/en/articles/about-stars) it. Appreciation really helps in keeping this project alive.

### Contributing

Please read [CONTRIBUTING.md](https://github.com/NextHub-Team/FireBox/blob/master/.github/CONTRIBUTING.md) for details on the process for submitting pull requests to us.

### Code of conduct

Code of conduct guidelines [here](https://github.com/NextHub-Team/FireBox/blob/master/.github/CODE_OF_CONDUCT.md).

### License

[MIT](https://github.com/NextHub-Team/FireBox/blob/master/LICENSE)
